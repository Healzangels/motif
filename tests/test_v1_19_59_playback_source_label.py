...
def test_helper_handles_bk_rows():
    ...
    # v0.51.339: named once, only where Plex serves no theme (v0.51.344 wording) — the matrix is tests/test_v0_51_339_ui_residuals.py
    assert body.count("PROMOTE TO ACTIVE") == 1 and "Plex serves no theme (PROMOTE TO ACTIVE" in body
